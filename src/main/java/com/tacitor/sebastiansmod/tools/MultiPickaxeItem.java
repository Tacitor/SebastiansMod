...
public class MultiPickaxeItem extends PickaxeItem{    
    ...
    public boolean canHarvestBlock(BlockState block) {
        return RegistryHandler.HACKAXE_EFFECTIVE_ON.contains(block.getBlock()) ? true : super.canHarvestBlock(block);
    }
    ...
    public float getDestroySpeed(ItemStack stack, BlockState state) {
        ...
        return RegistryHandler.HACKAXE_EFFECTIVE_ON.contains(state.getBlock()) ? this.efficiency : super.getDestroySpeed(stack, state);
    }
}
